...
urlpatterns = [
        ...
        re_path(r'^(?P<car_id>([a-fA-F0-9]{8}-(?:[a-fA-F0-9]{4}-){3}[a-fA-F0-9]{12}){1})/details/$',FullVoitureRetrieveView.as_view(), name='details_voiture'),
        re_path(r'^(?P<car_id>([a-fA-F0-9]{8}-(?:[a-fA-F0-9]{4}-){3}[a-fA-F0-9]{12}){1})/consommation/$',ConsoVoitureRetrieveView.as_view(), name='consommation'),
        re_path(r'^(?P<car_id>([a-fA-F0-9]{8}-(?:[a-fA-F0-9]{4}-){3}[a-fA-F0-9]{12}){1})/updestroy/$',FullVoitureUDView.as_view(), name='updestroy'),
